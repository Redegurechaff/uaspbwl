...
<body class="d-flex align-items-center justify-content-center vh-100" style="background-color: #fffffe">
    <div class="container">
        <div class="row align-items-center text-white">
            <div class="col-md-6" style="color : #8FBC8F">
              
                <h1>KELEN ISI DULU EMAIL AMA PASSWORD KELEN</h1>
            ...
            <div class="col-md-6">
                <div class="card p-4" style="backgound-color : #fffffe">
                    ...
                    <form method="POST" action="{{ route('login-proses') }}">
                        ...
                        <button type="submit" class="btn text-white" style="background-color : #8FBC8F">Login</button>
                    </form>
                </div>
            </div>
        </div>
